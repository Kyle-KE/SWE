...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'selectShop',
          path: '/selectShop',
          builder: (context, params) => const SelectShopWidget(),
        ),
        FFRoute(
          name: 'Home',
          path: '/home',
        ...
        FFRoute(
          ...
          path: '/myOrders',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'myOrders')
        ...
        FFRoute(
          name: 'OrderCompleted',
          path: '/orderCompleted',
          builder: (context, params) => const OrderCompletedWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
        ...
        FFRoute(
          name: 'redeem',
          path: '/redeem',
          builder: (context, params) => const RedeemWidget(),
        )

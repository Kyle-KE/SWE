...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF324A59);
  late Color secondary = const Color(0xFF0A84FF);
  late Color tertiary = const Color(0xFF7B6F72);
  late Color alternate = const Color(0xFFAAAAAA);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF757575);
  late Color accent2 = const Color(0xFF001833);
  late Color accent3 = const Color(0xFFFF9500);
  late Color accent4 = const Color(0xFF34C759);

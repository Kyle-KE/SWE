...
import 'order_completed_model.dart';
export 'order_completed_model.dart';

class OrderCompletedWidget extends StatefulWidget {
  const OrderCompletedWidget({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Kyle, your order has been sucessfully placed.',
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(0.0, 87.0, 0.0, 0.0),
                child: Text(
              ...
              Padding(
                ...
                child: Text(
                  'at the cafeteria to receive an order.',
                  textAlign: TextAlign.center,
                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                        fontFamily: 'Readex Pro',
                        color: FlutterFlowTheme.of(context).alternate,
